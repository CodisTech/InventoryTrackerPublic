...
echo "   git remote add origin https://github.com/codistech/inventory-management-system.git"
echo "   git push -u origin main"
echo "3. In your GitHub repository settings, enable GitHub Pages from the main branch"
echo ""
echo "Your GitHub Pages site will be available at: https://codistech.github.io/inventory-management-system/"